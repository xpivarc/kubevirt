...
var _ = Describe("Application", func() {
	...
	It("Reports leader prometheus metric when onStartedLeading is called ", func() {
		...
		app.vmiController = NewVMIController(services.NewTemplateService("a", "b", "c", "d", "e", "f", "g", pvcInformer.GetStore(), virtClient, config, qemuGid, false),
			vmiInformer,
			podInformer,
			pvcInformer,
			recorder,
		...
		app.migrationController = NewMigrationController(services.NewTemplateService("a", "b", "c", "d", "e", "f", "g", pvcInformer.GetStore(), virtClient, config, qemuGid, false),
			vmiInformer,
			podInformer,
			migrationInformer,
			recorder,
