...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryHotplugOption) DeepCopyInto(out *MemoryHotplugOption) {
	*out = *in
	out.Guest = in.Guest.DeepCopy()
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryHotplugOption.
func (in *MemoryHotplugOption) DeepCopy() *MemoryHotplugOption {
	if in == nil {
		return nil
	}
	out := new(MemoryHotplugOption)
	in.DeepCopyInto(out)
	return out
}
