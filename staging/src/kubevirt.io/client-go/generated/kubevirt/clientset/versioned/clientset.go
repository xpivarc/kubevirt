...
type Interface interface {
	...
	UsbV1alpha1() usbv1alpha1.UsbV1alpha1Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	usbV1alpha1          *usbv1alpha1.UsbV1alpha1Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.usbV1alpha1, err = usbv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.usbV1alpha1 = usbv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.usbV1alpha1 = usbv1alpha1.New(c)
